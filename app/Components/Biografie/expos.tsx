        ...
        <ul className="grid grid-cols-2 md:grid-cols-3 gap-x-8 max-w-max m-auto text-left text-gray-500 dark:text-gray-400">
            {expos.map((expo) => (
                <li key="" className="flex items-center">
                    <svg key="" className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
